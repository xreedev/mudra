...
export class AslRelaySender {
  ...
  /**
   * TCP is full-duplex, so the same socket used to send also carries whatever the receiver
   * phone sends back — e.g. a spoken reply transcribed to text on their end — which arrives
   * here via `onMessage`.
   */
